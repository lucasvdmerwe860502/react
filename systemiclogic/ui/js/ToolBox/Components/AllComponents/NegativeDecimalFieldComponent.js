...
import IsNegativeDecimal from '../../Modules/Validation/IsNegativeDecimal';
var $=require('jquery');

export default class NegativeDecimalFieldComponent extends Component {
    ...
    OnChangeFunction = (event)=> {
        ...
        var validity=new ValidationContextClass(new IsNegativeDecimal(value)).StartValidation();
    ...
    OnFieldBlur = (event)=> {
        ...
        if(value==="-")
        {
            this.props.OnChangeCallBackFunction('');
        }
                            ...
                            <tr>
                                ...
                                <td style={{verticalAlign:'top'}}>
                                    ...
                                    <div style={{marginTop: 10, fontSize: '0.9em', color: 'black'}}>
                                        {charsRemainingToUse}/{this.props.MaxLength} maximum
                                    </div>
                                </td>
                            </tr>
                        </tbody>
