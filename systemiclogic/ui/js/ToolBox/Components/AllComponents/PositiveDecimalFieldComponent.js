...
import IsPositiveDecimal from '../../Modules/Validation/IsPositiveDecimal';
var $=require('jquery');

export default class PositiveDecimalFieldComponent extends Component {
    ...
    OnChangeFunction = (event)=> {
        ...
        var validity=new ValidationContextClass(new IsPositiveDecimal(value)).StartValidation();
