...
import IsTelNumber from '../../Modules/Validation/IsTelNumber';

export default class TelFieldComponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    OnChangeFunction = (event)=> {
        ...
        var validity = new ValidationContextClass(new IsTelNumber(value)).StartValidation();
        ...
        if (charsRemainingToUse >= 0 && validity === true) {
            ...
            if (validity === false && php.ctype_digit(value) === true) {
                this.props.OnChangeCallBackFunction(value);
                this.setState((prevState)=>({
                    BorderColor:this.props.FocusBorderColor
                }));
