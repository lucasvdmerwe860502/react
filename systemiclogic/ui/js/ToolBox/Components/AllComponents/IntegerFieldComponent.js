...
import IsInteger from '../../Modules/Validation/IsInteger';

export default class IntegerFieldComponent extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    OnChangeFunction = (event)=> {
        ...
        var validity=new ValidationContextClass(new IsInteger(value)).StartValidation();
