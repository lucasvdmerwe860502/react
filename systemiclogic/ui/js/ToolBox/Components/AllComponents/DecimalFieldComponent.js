...
import IsDecimal from '../../Modules/Validation/IsDecimal';
var $=require('jquery');

export default class DecimalFieldComponent extends Component {
    ...
    OnChangeFunction = (event)=> {
        ...
        var validity=new ValidationContextClass(new IsDecimal(value)).StartValidation();
