...
import IsNegativeInteger from '../../Modules/Validation/IsNegativeInteger';

export default class NegativeIntegerFieldComponent extends Component{
    constructor(props) {
        super(props);
        this.state = {
    ...
    OnChangeFunction = (event)=> {
        ...
        var validity=new ValidationContextClass(new IsNegativeInteger(value)).StartValidation();
